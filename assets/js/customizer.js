...
(function ($) {
    ...
    $('#theme-chooser').find('[data-theme=' + sharedVariables.$currentTheme + ']').parent().addClass('active');
    $('#layout-chooser').find('[data-layout=' + sharedVariables.$currentLayout + ']').parent().addClass('active');
    $('#theme-style-chooser').find('[data-style=' + sharedVariables.$currentThemeStyle + ']').addClass('active');
