...
class ArticleTypeRepository extends ServiceEntityRepository
{
    ...
    public function add(ArticleType $entity, bool $flush = false): void
    {
    ...
    /**
     * @return QueryBuilder Returns an array of ArticleType objects
     */
    public function findAllArticleTypeName(): QueryBuilder
    {
