...
class TutoringRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, Tutoring::class);
    }

    public function add(Tutoring $entity, bool $flush = false): void
    {
    ...
    public function remove(Tutoring $entity, bool $flush = false): void
    {
...
//    /**
//     * @return Tutoring[] Returns an array of Tutoring objects
//     */
...
//    public function findOneBySomeField($value): ?Tutoring
//    {
//        return $this->createQueryBuilder('t')
//            ->andWhere('t.exampleField = :val')
//            ->setParameter('val', $value)
