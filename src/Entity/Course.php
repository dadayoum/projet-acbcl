...
class Course
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=SessionEvent::class, mappedBy="course", cascade={"persist", "remove"})
     */
    ...
    public function removeSessionEvent(SessionEvent $sessionEvent): self
    {
        if ($this->sessionsEvent->removeElement($sessionEvent)) {
            ...
            if ($sessionEvent->getCourse() === $this) {
                $sessionEvent->setCourse(null);
            }
        }
